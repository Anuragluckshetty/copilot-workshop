...
The home page catalog can be filtered by one or more categories and by publisher. Filters are applied through the accessible GET form and are preserved in the URL for sharing or refreshing.
